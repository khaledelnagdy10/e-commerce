...
// class HeaderProducts extends StatefulWidget {
//   HeaderProducts({
//     super.key,
...
//   @override
//   State<HeaderProducts> createState() => _HeaderProductsState();
// }

// class _HeaderProductsState extends State<HeaderProducts> {
//   @override
...
//               Text(widget.categoryName, style: Style.textStyleBold24Black),
//               Container(
...
//                                     title: Text('Popular'),
//                                   ),
//                                   ListTile(onTap: () {}, title: Text('Newest')),
//                                   ListTile(
//                                     onTap: () {
//                                       setState(() {
//                                         widget.sortType = 2;
...
//                       onPressed: () {
//                         setState(() {
//                           widget.sortType = widget.sortType == 0 ? 1 : 0;
//                         });
//                       },
//                       icon: FaIcon(
//                         widget.sortType == 0
