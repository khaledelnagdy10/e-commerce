...
import 'package:store_app2/features/presentation/shop/features/widgets/product_category_widgets/grid_products_category_list_view_builder.dart';
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: GridProductsCategoryListViewBuilder(sortType: sortType),
          ),
        ],
      ),
    );
