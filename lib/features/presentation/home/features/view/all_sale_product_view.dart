...
class AllSaleProductsView extends StatefulWidget {
  const AllSaleProductsView({super.key, required this.categoryName});
  final String categoryName;
  @override
  State<AllSaleProductsView> createState() => _AllSaleProductsViewState();
}

class _AllSaleProductsViewState extends State<AllSaleProductsView> {
  @override
  void initState() {
    super.initState();
      ...
      body: BlocBuilder<AllProductCubit, AllProductState>(
        builder: (context, state) {
          ...
          if (state is AllProductCubitSuccess) {
            final products = context.read<AllProductCubit>().clothesProducts;
